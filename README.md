...
This repository demonstrates how to build Amazon Machine Images (AMIs) using Packer and deploy them across multiple AWS accounts and regions using GitHUb Actions. We utilized **AWS Control Tower** and **IAM access keys** from the main AWS account for authentication.
...
![Configure Accounts and Regions]().PNG)
